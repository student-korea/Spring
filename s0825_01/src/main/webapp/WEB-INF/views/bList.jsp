  ...
  <section>
      ...
      <form action="/search" name="search" method="get">
        ...
        <script>
        	function searchBtn(){
        		...
        		var world=$("#sWord").val();
        		//alert($("#category").val()+","+$("#sWord").val()+"검색!!");
        		location.href="/search?category="+category+"&sWord="+sWord;
        	}
        </script>
      </form>
    </div>
    ...
    <table>
      ...
      <c:forEach var="board" items="${list}" >
	      <tr>
	        <td>${board.bno}</td>
	        <td class="table-title"><a href ="/bView/${board.bno}">${board.btitle}</a></td>
	        <td>${board.id}</td>
